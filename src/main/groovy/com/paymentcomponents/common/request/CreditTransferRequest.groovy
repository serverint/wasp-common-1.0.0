...
class CreditTransferRequest {
    ...
    public String toString() {
        return "CreditTransferRequest{" +
                ...
                ", transactionLocationInformation=" + transactionLocationInformation.toString() +
                ", debtorInformation=" + debtorInformation.toString() +
                ", creditorInformation=" + creditorInformation.toString() +
                ", remittanceInformation=" + remittanceInformation.toString() +
                '}';
    }
}
