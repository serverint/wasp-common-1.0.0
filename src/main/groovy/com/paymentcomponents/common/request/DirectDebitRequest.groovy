...
/**
 * Created by t.logothetis on 19/05/2017.
 */
...
class DirectDebitRequest {
    ...
    DirectDebitRequest(UUID id, String requestId, Date creationDateTime, String instructingInstitutionCode, String instructedInstitutionCode, String instructingInstitutionBic, String instructedInstitutionBic, int channelCode, String transactionId, String endToEndId, Date valueDate, String currency, Double amount, String chargeBearer, Double chargesAmount, Double instructedAmount, String accountEnquiryReference, String mandateReference, String transactionRiskValue, String bankHttpResponseCode, String bankResponseBody, TransactionLocationInformation transactionLocationInformation, DebtorInformation debtorInformation, CreditorInformation creditorInformation, RemittanceInformation remittanceInformation) {
        this.id = id
